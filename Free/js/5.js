...
(gj.widget = function () {
  ...
  (gj.widget.prototype.init = function (a, b) {
    ...
    for (plugin in gj[b].plugins)
      gj[b].plugins.hasOwnProperty(plugin) &&
        gj[b].plugins[plugin].configure(this, e, d);
    return this;
  }),
  (gj.widget.prototype.getConfig = function (a, b) {
    ...
    for (f in gj[b].plugins)
      gj[b].plugins.hasOwnProperty(f) &&
        ...
        gj[b].plugins[f].config[d] &&
          $.extend(!0, c, gj[b].plugins[f].config[d]),
        gj[b].plugins[f].config[e] &&
          $.extend(!0, c, gj[b].plugins[f].config[e]));
  ...
  (gj.documentManager = {
    ...
    subscribeForEvent: function (a, b, c) {
      if (
        ...
        0 !== gj.documentManager.events[a].length
      ) {
        if (gj.documentManager.events[a][b])
          throw (
            'Event ' +
            a +
            ' for widget with guid="' +
            b +
            '" is already attached.'
          );
      ...
      if (d)
        for (var e = 0; e < d.length; e++)
          d[e].widgetId === b &&
            ...
            (c = !0),
            0 === d.length &&
              ($(document).off(a), delete gj.documentManager.events[a]));
      if (!c)
        throw (
          'The "' + a + '" for widget with guid="' + b + '" can\'t be removed.'
        );
    },
  }),
  (gj.core = {
        ...
        if (/^\d+$/.test(a)) g = new Date(a);
          ...
          for (
            ...
            ['d', 'dd'].indexOf(f[d]) > -1
              ...
              ? (i = parseInt(e[d], 10) - 1)
              : 'mmm' === f[d]
              ? (i = gj.core.messages[c || 'en-us'].monthShortNames.indexOf(
                  e[d]
                ))
              : 'mmmm' === f[d]
    ...
    formatDate: function (a, b, c) {
      ...
      for (h = h.splice(1, h.length - 2), i = 0; i < g.length; i++)
        switch (((d = h[i] || ''), g[i])) {
          ...
          case 'mmm':
            f +=
              gj.core.messages[c || 'en-us'].monthShortNames[a.getMonth()] + d;
            break;
          case 'mmmm':
      ...
      return (
        'border-box' === d.boxSizing
          ? ((c = parseInt(d.height, 10)),
            gj.core.isIE() &&
              ((c +=
                parseInt(d.paddingTop || 0, 10) +
                parseInt(d.paddingBottom || 0, 10)),
              (c +=
                parseInt(d.borderTopWidth || 0, 10) +
                parseInt(d.borderBottomWidth || 0, 10))))
          : ((c = parseInt(d.height, 10)),
            (c +=
              parseInt(d.paddingTop || 0, 10) +
              parseInt(d.paddingBottom || 0, 10)),
        ...
        b &&
          (c +=
            parseInt(d.marginTop || 0, 10) + parseInt(d.marginBottom || 0, 10)),
        c
      );
    },
    width: function (a, b) {
      ...
      return (
        'border-box' === d.boxSizing
          ...
          : ((c = parseInt(d.width, 10)),
            (c +=
              parseInt(d.paddingLeft || 0, 10) +
              parseInt(d.paddingRight || 0, 10)),
            (c +=
              parseInt(d.borderLeftWidth || 0, 10) +
              parseInt(d.borderRightWidth || 0, 10))),
        b &&
          (c +=
            parseInt(d.marginLeft || 0, 10) + parseInt(d.marginRight || 0, 10)),
        c
      );
    },
    ...
    position: function (a) {
      for (
        var b, c, d = 0, e = 0, f = gj.core.height(a), g = gj.core.width(a);
        a;
    ...
    getScrollParent: function (a) {
      return null == a
        ...
        ? a
        : gj.core.getScrollParent(a.parentNode);
    },
  }),
  ...
  (gj.picker.methods = {
    initialize: function (a, b, c) {
      ...
      (d =
        ...
        0 === f.length
          ? ((f = $('<div role="wrapper" />').addClass(b.style.wrapper)),
            a.wrap(f))
        ...
        'bootstrap' === b.uiLibrary || 'bootstrap4' === b.uiLibrary
          ? 'small' === b.size
            ...
            : 'large' === b.size &&
              (f.addClass('input-group-lg'), a.addClass('form-control-lg'))
          : 'small' === b.size
          ? f.addClass('small')
  ...
  (gj.picker.widget.prototype.open = function (a) {
    var b = this.data(),
      c = $('body').find(
        '[role="picker"][guid="' + this.attr('data-guid') + '"]'
      );
    return (
      c.show(),
      ...
      b.modal
        ? gj.core.center(c)
        : (gj.core.setChildPosition(this[0], c[0]), this.focus()),
  ...
  (gj.dialog.methods = {
    ...
    localization: function (a) {
      var b = a.data();
      void 0 === b.title &&
        (b.title = gj.dialog.messages[b.locale].DefaultTitle);
    },
    ...
    initialize: function (a) {
      ...
      a.addClass(e.style.content),
        ...
        0 === c.length
          ? ((c = $('<div data-role="body"/>').addClass(e.style.body)),
            a.wrapInner(c))
        ...
        gj.draggable &&
          (e.draggable && gj.dialog.methods.draggable(a, b),
          e.resizable && gj.dialog.methods.resizable(a)),
        e.scrollable &&
          e.height &&
          (a.addClass('gj-dialog-scrollable'),
          a.on('opened', function () {
            a.children('div[data-role="body"]').css(
              'height',
              e.height - b.outerHeight() - (d.length ? d.outerHeight() : 0)
            );
          })),
        gj.core.center(a),
        e.modal &&
          a.wrapAll('<div data-role="modal" class="' + e.style.modal + '"/>'),
        e.autoOpen && a.open();
    },
    setSize: function (a) {
      var b = a.data();
    ...
    renderHeader: function (a) {
      ...
      return (
        ...
        0 === c.length &&
          ((c = $('<h4 data-role="title">' + e.title + '</h4>')), b.append(c)),
    ...
    resizable: function (a) {
      ...
      a.append(
        $('<div class="gj-resizable-handle gj-resizable-n"></div>').draggable(
          $.extend(!0, { horizontal: !1 }, b)
        )
      ),
        a.append(
          $('<div class="gj-resizable-handle gj-resizable-e"></div>').draggable(
            $.extend(!0, { vertical: !1 }, b)
          )
        ),
        a.append(
          $('<div class="gj-resizable-handle gj-resizable-s"></div>').draggable(
            $.extend(!0, { horizontal: !1 }, b)
          )
        ),
        a.append(
          $('<div class="gj-resizable-handle gj-resizable-w"></div>').draggable(
            $.extend(!0, { vertical: !1 }, b)
          )
        ),
        a.append(
          $(
            '<div class="gj-resizable-handle gj-resizable-ne"></div>'
          ).draggable($.extend(!0, {}, b))
        ),
        a.append(
          $(
            '<div class="gj-resizable-handle gj-resizable-nw"></div>'
          ).draggable($.extend(!0, {}, b))
        ),
        a.append(
          $(
            '<div class="gj-resizable-handle gj-resizable-sw"></div>'
          ).draggable($.extend(!0, {}, b))
        ),
        a.append(
          $(
            '<div class="gj-resizable-handle gj-resizable-se"></div>'
          ).draggable($.extend(!0, {}, b))
        );
    },
    resize: function (a, b) {
      ...
      return (
        ...
        c.length &&
          ...
          a
            ...
            .css('margin-bottom', c.outerHeight()),
  ...
  (gj.draggable.config = {
    base: { handle: void 0, vertical: !0, horizontal: !0, containment: void 0 },
  }),
  (gj.draggable.methods = {
    init: function (a) {
      ...
      return (
        ...
        gj.documentManager.subscribeForEvent(
          'mouseup',
          d.data('guid'),
          gj.draggable.methods.createUpHandler(d)
        ),
        gj.documentManager.subscribeForEvent(
          'touchend',
          d.data('guid'),
    ...
    move: function (a, b, c, d, e, f) {
      ...
      b.containment &&
        ...
        k > g.top && k < h
          ? (g.top >= f || g.bottom <= f) && (k = j.top)
          : (k = k <= g.top ? g.top + 1 : h - 1),
        l > g.left && l < i
          ? (g.left >= e || g.right <= e) && (l = j.left)
          : (l = l <= g.left ? g.left + 1 : i - 1)),
        !1 !== gj.draggable.events.drag($(a), l, k, e, f) &&
          ((a.style.top = k + 'px'), (a.style.left = l + 'px'));
    },
    destroy: function (a) {
      return (
  ...
  (gj.droppable.methods = {
    init: function (a) {
      ...
      return (
        ...
        gj.documentManager.subscribeForEvent(
          'mouseup',
          b.data('guid'),
          gj.droppable.methods.createMouseUpHandler(b)
        ),
        b
      );
    },
    ...
    isOver: function (a, b) {
      ...
      return (
        b.x > d &&
        b.x < d + a.outerWidth(!0) &&
        b.y > c &&
        b.y < c + a.outerHeight(!0)
      );
    },
    destroy: function (a) {
      return (
  ...
  (gj.grid.config = {
    ...
    bootstrap: {
      style: {
        wrapper: 'gj-grid-wrapper',
        table:
          'gj-grid gj-grid-bootstrap gj-grid-bootstrap-3 table table-bordered table-hover',
    ...
    bootstrap4: {
      style: {
        wrapper: 'gj-grid-wrapper',
        table:
          'gj-grid gj-grid-bootstrap gj-grid-bootstrap-4 table table-bordered table-hover',
        content: { rowSelected: 'active' },
      },
  ...
  (gj.grid.methods = {
    ...
    getConfig: function (a, b) {
      ...
      return (
        gj.grid.methods.setDefaultColumnConfig(
          c.columns,
          c.defaultColumnSettings
        ),
        c
      );
    },
    ...
    initialize: function (a) {
      ...
      gj.grid.methods.localization(b),
        0 === c.length
          ? ((c = $('<div data-role="wrapper" />').addClass(b.style.wrapper)),
            a.wrap(c))
    ...
    localization: function (a) {
      a.notFoundText ||
        (a.notFoundText = gj.grid.messages[a.locale].NoRecordsFound);
    },
    renderHeader: function (a) {
      ...
      for (
        ...
        (g = $('<th data-field="' + (c[i].field || '') + '" />')),
          c[i].width
            ...
            : 'checkbox' === c[i].type &&
              g.attr('width', b.defaultIconColumnWidth),
          g.addClass(d.cell),
          ...
          'selectRow' === c[i].role
            ...
            : ((h = $('<div data-role="title"/>').html(
                void 0 === c[i].title ? c[i].field : c[i].title
              )),
              g.append(h),
              c[i].sortable &&
                (h.addClass(d.sortable),
                h.on('click', gj.grid.methods.createSortHandler(a, c[i])))),
          c[i].hidden && g.hide(),
          f.append(g);
      e.empty().append(f);
    },
    ...
    updateHeader: function (a) {
      ...
      a.find('thead tr th [data-role="sorticon"]').remove(),
        e &&
          ...
          position > -1 &&
            ((c = a.find(
              'thead tr th:eq(' + position + ') div[data-role="title"]'
            )),
            (b = $(
              '<div data-role="sorticon" class="gj-unselectable" />'
            ).append('desc' === f ? d.icons.desc : d.icons.asc)),
            c.after(b)));
    },
        ...
        for (c = Object.getOwnPropertyNames(b[0]), f = 0; f < c.length; f++)
          (d = b[0][c[f]]),
            ...
            d &&
              ('number' == typeof d
                ? (e = 'number')
                : d.indexOf('/Date(') > -1 && (e = 'date')),
            g.columns.push({ field: c[f], type: e });
        gj.grid.methods.setDefaultColumnConfig(
          g.columns,
          g.defaultColumnSettings
        );
      }
      gj.grid.methods.renderHeader(a);
    },
      ...
      for (
        h = a.data(),
          b && 0 !== b.length
            ...
            : ((i = 'create'),
              (b = $('<tr data-role="row"/>')),
              a.children('tbody').append(b)),
          e = gj.grid.methods.getId(c, h.primaryKey, d + 1),
          b.attr('data-position', d + 1),
          'checkbox' !== h.selectionMethod &&
            b.on('click', gj.grid.methods.createRowClickHandler(a, e)),
          g = 0;
        g < h.columns.length;
        g++
      )
        'update' === i
          ? ((f = b.find('td:eq(' + g + ')')),
            gj.grid.methods.renderCell(a, f, h.columns[g], c, e))
    ...
    renderCell: function (a, b, c, d, e, f) {
      ...
      return (
        c.hidden && b.hide(), gj.grid.events.cellDataBound(a, g, e, c, d), b
      );
    },
    ...
    renderDisplayElement: function (a, b, c, d, e, f) {
      ...
      'checkbox' === c.type && gj.checkbox
        ...
        : 'icon' === c.type
        ? 'create' === f &&
          (b.append($('<span/>').addClass(c.icon).css({ cursor: 'pointer' })),
          'bootstrap' === a.data().uiLibrary &&
            b.children('span').addClass('glyphicon'),
          (c.stopPropagation = !0))
        : c.tmpl
        ? ((g = c.tmpl),
      ...
      return (
        $.isArray(b)
          ...
          : e &&
            ...
            ((c = b[e.mapping.dataField]),
            ((d = b[e.mapping.totalRecordsField]) && !isNaN(d)) || (d = 0)),
        a.data('records', c),
      ...
      return (
        a.find('tbody tr').each(function () {
          ...
          gj.grid.methods.unselectRow(a, b, c, f),
            c
              .find('input[type="checkbox"][data-role="selectRow"]')
              .prop('checked', !1);
        }),
        a.find('thead input[data-role="selectAll"]').prop('checked', !1),
        a
    ...
    getSelected: function (a) {
      ...
      return (
        ...
        b.length > 0 &&
          ((d = $(b[0]).data('position')),
          (c = a.get(d)),
          (e = gj.grid.methods.getId(c, a.data().primaryKey, d))),
        e
      );
    },
        ...
        0 < f.length &&
          f.each(function () {
            (b = $(this).data('position')),
              (c = a.get(b)),
              d.push(gj.grid.methods.getId(c, e.primaryKey, b));
          }),
        d
      );
    },
    ...
    getRowById: function (a, b) {
      ...
      return (
        c &&
          (g = a.children('tbody').children('tr[data-position="' + c + '"]')),
        g
      );
    },
    ...
    getCell: function (a, b, c) {
      ...
      return (
        ...
        d > -1 &&
          ...
          (f = e.find('td:eq(' + d + ') div[data-role="display"]'))),
        f
      );
    },
    ...
    render: function (a, b) {
      return (
        b &&
          (gj.grid.methods.setRecordsData(a, b),
          gj.grid.methods.updateHeader(a),
          gj.grid.methods.loadData(a)),
        a
      );
    },
    filter: function (a) {
      ...
      for (b in d.params)
        d.params[b] &&
          ...
          (e = $.grep(e, function (a) {
            var e = a[b] || '',
              f = d.params[b] || '';
            return c && 'function' == typeof c.filter
              ? c.filter(e, f)
              : e.toUpperCase().indexOf(f.toUpperCase()) > -1;
          })));
    ...
    destroy: function (a, b, c) {
      return (
        a.data() &&
          ...
          a.off(),
          !1 === c &&
            a.parent('div[data-role="wrapper"]').length > 0 &&
            a.unwrap(),
          a.removeData(),
    ...
    showColumn: function (a, b) {
      ...
      return (
        e > -1 &&
          ...
          c &&
            c.length &&
            c.attr('colspan', gj.grid.methods.countVisibleColumns(a)),
    ...
    addRow: function (a, b) {
      ...
      return (
        ...
        gj.grid.methods.isLastRecordVisible(a) &&
          gj.grid.methods.renderRow(a, null, b, a.count() - 1),
    ...
    updateRow: function (a, b, c) {
      ...
      return (
        ...
        $.isArray(f.dataSource) &&
          ((d = gj.grid.methods.getRecVPosById(a, b)), (f.dataSource[d] = c)),
    ...
    removeRow: function (a, b) {
      ...
      return (
        ...
        $.isArray(d.dataSource) &&
          ((c = gj.grid.methods.getRecVPosById(a, b)),
          d.dataSource.splice(c, 1)),
        a.reload(),
        a
      );
    },
  ...
  (gj.grid.plugins.fixedHeader = {
    ...
    private: {
      init: function (a) {
        var b = a.data(),
          ...
          e =
            b.height -
            d.outerHeight() -
            (a.children('tfoot').outerHeight() || 0);
      ...
      refresh: function (a) {
        ...
        for (
          a.children('tbody').height() <
          gj.grid.plugins.fixedHeader.private.getRowsHeight(a)
            ? d.css(
                'width',
                e.outerWidth() +
      ...
      getScrollBarWidth: function () {
        ...
        var d = a.offsetWidth;
        return (
          c == d && (d = b.clientWidth), document.body.removeChild(b), c - d
        );
      },
    },
    public: {},
    ...
    private: {
      expandDetail: function (a, b, c) {
        var d = b.closest('tr'),
          ...
          f = $(
            '<td colspan="' + gj.grid.methods.countVisibleColumns(a) + '" />'
          ),
          g = $('<div data-role="display" />'),
          h = a.data(),
          i = d.data('position'),
      ...
      collapseDetail: function (a, b, c) {
        ...
        void 0 === typeof c &&
          (c = gj.grid.methods.getId(record, f.primaryKey, record)),
          e.remove(),
          b
            .children('div[data-role="display"]')
            .empty()
      ...
      updateDetailsColSpan: function (a) {
        ...
        b &&
          b.length &&
          b.attr('colspan', gj.grid.methods.countVisibleColumns(a));
      },
    },
    public: {
        ...
        return (
          void 0 !== c.detailTemplate &&
            ...
            b.find('tbody tr[data-role="row"]').each(function () {
              gj.grid.plugins.expandCollapseRows.private.collapseDetail(
                b,
                $(this).find('td:eq(' + a + ')')
              );
            })),
          void 0 !== c.grouping &&
            b.find('tbody tr[role="group"]').each(function () {
              gj.grid.plugins.grouping.private.collapseGroup(
                c,
                $(this).find('td:eq(0)')
              );
            }),
      ...
      expandAll: function () {
        ...
        return (
          void 0 !== c.detailTemplate &&
            ((a = gj.grid.methods.getColumnPositionByRole(b, 'expander')),
            b.find('tbody tr[data-role="row"]').each(function () {
              gj.grid.plugins.expandCollapseRows.private.expandDetail(
                b,
                $(this).find('td:eq(' + a + ')')
              );
            })),
          void 0 !== c.grouping &&
            b.find('tbody tr[role="group"]').each(function () {
              gj.grid.plugins.grouping.private.expandGroup(
                c,
                $(this).find('td:eq(0)')
              );
            }),
          ...
          ((b = {
            ...
            events: {
              click: function (b) {
                ...
                'details' === c.closest('tr').next().attr('data-role')
      ...
      if ('edit' !== b.attr('data-mode'))
        if (c.editor) {
          if (
            ...
            0 === f.length &&
              ((f = $('<div data-role="edit" />')), b.append(f)),
            ...
            if ('function' == typeof c.editor)
              ...
              (g = $('<input type="checkbox" />').prop('checked', h)),
                f.append(g),
                g.checkbox(i);
            else if (
              ...
              'dropdown' === c.type && gj.dropdown
                ...
                : ((g = $(
                  ...
                  'materialdesign' === j.uiLibrary &&
                    g
                      .addClass('gj-textbox-md')
            ...
            'command' !== j.inlineEditing.mode &&
              ...
              g.on('keyup', function (d) {
                (13 !== d.keyCode && 27 !== d.keyCode) ||
                  gj.grid.plugins.inlineEditing.private.displayMode(a, b, c);
              }));
          }
          'INPUT' === g.prop('tagName').toUpperCase() &&
          'TEXT' === g.prop('type').toUpperCase()
      ...
      'editOnly' !== c.mode &&
        ('edit' === b.attr('data-mode') &&
          ...
          'SELECT' === g[0].tagName.toUpperCase() && g[0].selectedIndex > -1
            ? ((h = g[0].options[g[0].selectedIndex].innerHTML),
              (i = g[0].value))
            : (h =
                'INPUT' === g[0].tagName.toUpperCase() &&
                'CHECKBOX' === g[0].type.toUpperCase()
                  ? g[0].checked
                  : g.val()),
          ...
          !0 !== d &&
            h !== j[c.field] &&
            ((j[c.field] =
              'date' === c.type ? gj.core.parseDate(h, c.format) : h),
            ...
            'editOnly' !== c.mode &&
              ...
              0 === b.find('span.gj-dirty').length &&
                b.prepend($('<span class="gj-dirty" />'))),
      ...
      h.guid || (h.guid = gj.grid.plugins.inlineEditing.private.generateGUID()),
        h.primaryKey &&
          ...
          f && 1 === f.length
            ? (f[0][b.field] = d)
            : ((g = {}),
              (g[h.primaryKey] = c[h.primaryKey]),
              h.primaryKey !== b.field && (g[b.field] = d),
              e.push(g)),
  ...
  (gj.grid.plugins.inlineEditing.public = {
    ...
    update: function (a) {
      var b,
        ...
        e = this.data('columns');
      for (b = 0; b < d.length; b++)
        gj.grid.plugins.inlineEditing.private.displayMode(
          this,
          $(d[b]),
          e[b],
          !1
      ...
      return (
        gj.grid.plugins.inlineEditing.events.rowDataChanged(this, a, c), this
      );
    },
    cancel: function (a) {
      var b,
        c =
          (this.getById(a), gj.grid.methods.getRowById(this, a).children('td')),
        d = this.data('columns');
    ...
    $.extend(!0, a, gj.grid.plugins.inlineEditing.public),
      ...
      'command' === d.inlineEditing.mode
        ? (gj.grid.plugins.inlineEditing.private.localization(d),
          b.inlineEditing.managementColumn &&
            d.columns.push(b.inlineEditing.managementColumnConfig))
        : a.on('cellDataBound', function (b, c, e, f, g) {
            f.editor &&
              ('editOnly' === f.mode
                ? gj.grid.plugins.inlineEditing.private.editMode(
                    a,
                    c.parent(),
                    f,
                    g
  ...
  (gj.grid.plugins.optimisticPersistence = {
    config: {
      base: {
        optimisticPersistence: { localStorage: void 0, sessionStorage: void 0 },
      },
    },
    private: {
      ...
      saveParams: function (a) {
        ...
        if (d.optimisticPersistence.sessionStorage) {
          for (b = 0; b < d.optimisticPersistence.sessionStorage.length; b++)
            (c = d.optimisticPersistence.sessionStorage[b]),
              (e.optimisticPersistence[c] = d.params[c]);
          (e = $.extend(
            !0,
            JSON.parse(sessionStorage.getItem('gj.grid.' + d.guid)),
            e
          )),
        ...
        if (d.optimisticPersistence.localStorage) {
          for (
            e = { optimisticPersistence: {} }, b = 0;
            b < d.optimisticPersistence.localStorage.length;
            b++
          )
            (c = d.optimisticPersistence.localStorage[b]),
              (e.optimisticPersistence[c] = d.params[c]);
          (e = $.extend(
            !0,
            JSON.parse(localStorage.getItem('gj.grid.' + d.guid)),
            e
          )),
    ...
    configure: function (a, b, c) {
      b.guid &&
        (b.optimisticPersistence.localStorage ||
          b.optimisticPersistence.sessionStorage) &&
  ...
  (gj.grid.plugins.pagination = {
    config: {
      ...
      bootstrap4: {
        style: { pager: { panel: 'btn-toolbar', stateDisabled: '' } },
      },
      glyphicons: {
        icons: {
    ...
    private: {
        ...
        if (((d = a.data()), d.pager))
          for (
            d.params[d.paramNames.page] || (d.params[d.paramNames.page] = 1),
              d.params[d.paramNames.limit] ||
                (d.params[d.paramNames.limit] = d.pager.limit),
      ...
      reloadPager: function (a, b) {
        ...
        if (((h = a.data()), h.pager)) {
          for (
            ...
            gj.grid.plugins.pagination.private.reloadPagerControl(
              $(i[j]),
              a,
              c,
              e,
      ...
      reloadPagerControl: function (a, b, c, d, e, f, g) {
        ...
        switch (a.data('role')) {
          case 'page-first':
            gj.grid.plugins.pagination.private.assignPageHandler(
              b,
              a,
              1,
              c < 2
          ...
          case 'page-number':
            a.val(c)
              ...
              .on(
                'change',
                gj.grid.plugins.pagination.private.createChangePageHandler(b, c)
              );
            break;
          ...
          case 'page-button-one':
            (h = 1 === c ? 1 : c == d ? c - 2 : c - 1),
              gj.grid.plugins.pagination.private.assignButtonHandler(
                b,
                a,
                c,
                h,
      ...
      changePage: function (a, b) {
        ...
        !1 === gj.grid.plugins.pagination.events.pageChanging(a, b) ||
          isNaN(b) ||
          (a.find('TFOOT [data-role="page-number"]').val(b),
          (c.params[c.paramNames.page] = b)),
          a.reload();
      },
    ...
    configure: function (a, b, c) {
      ...
      a.data();
      c.pager &&
        ((gj.grid.methods.isLastRecordVisible =
          gj.grid.plugins.pagination.private.isLastRecordVisible),
        a.on('initialized', function () {
  ...
  (gj.grid.plugins.responsiveDesign = {
    ...
    private: {
        ...
        if (a.columns && a.columns.length) {
          for (i = 0; i < a.columns.length; i++)
            b.push({
              ...
              minWidth:
                a.columns[i].width ||
                a.columns[i].minWidth ||
                a.defaultColumn.minWidth,
      ...
      updateDetails: function (a) {
        var b, c, d, e, f, g, h, i, j;
        for (
          b = a.find('tbody > tr[data-role="row"]'), c = a.data(), d = 0;
          d < b.length;
          d++
        ) {
          for (
            f = $(b[d]), g = f.data('details'), e = 0;
            e < c.columns.length;
            e++
          )
            (i = c.columns[e]),
      ...
      makeResponsive: function () {
        ...
        for (a = 0; a < e.length; a++)
          (b = this.find('thead>tr>th:eq(' + e[a].position + ')')),
            b.is(':visible') &&
              e[a].minWidth < b.width() &&
              (c += b.width() - e[a].minWidth);
        if (c)
          for (a = 0; a < e.length; a++)
            (b = this.find('thead>tr>th:eq(' + e[a].position + ')')),
              !b.is(':visible') &&
                e[a].minWidth <= c &&
                (this.showColumn(e[a].field), (c -= b.width()));
        for (a = e.length - 1; a >= 0; a--)
          (b = this.find('thead>tr>th:eq(' + e[a].position + ')')),
            b.is(':visible') &&
              e[a].priority &&
              e[a].minWidth > b.outerWidth() &&
              this.hideColumn(e[a].field);
        return this;
      },
    },
    events: {
          ...
          (a.on('initialized', function () {
            a.makeResponsive(),
              ...
              (a.resizeCheckIntervalId = setInterval(function () {
                var b = a.width();
                b !== a.oldWidth &&
                  gj.grid.plugins.responsiveDesign.events.resize(
                    a,
                    b,
                    a.oldWidth
                  ),
  ...
  (gj.grid.plugins.toolbar = {
    ...
    private: {
      init: function (a) {
        ...
        (b = a.data()),
          ...
          (void 0 !== b.toolbarTemplate ||
            void 0 !== b.title ||
            c.length > 0) &&
            (0 === c.length &&
              ((c = $('<div data-role="toolbar"></div>')), a.before(c)),
            c.addClass(b.style.toolbar),
            0 === c.children().length &&
              b.toolbarTemplate &&
              c.append(b.toolbarTemplate),
            (d = c.find('[data-role="title"]')),
            0 === d.length &&
              ((d = $('<div data-role="title"/>')), c.prepend(d)),
    ...
    public: {
      title: function (a) {
        var b = this.parent().find(
          'div[data-role="toolbar"] [data-role="title"]'
        );
        ...
        if (((c = a.find('thead tr[data-role="caption"] th')), c.length)) {
          for (e = 0; e < c.length - 1; e++)
            (d = $(c[e])),
              ...
              (g = $('<span class="gj-grid-column-resizer" />').css(
                'margin-right',
                '-' + h + 'px'
              )),
              g.draggable({
                start: function () {
                  a.addClass('gj-unselectable'),
                    a.addClass('gj-grid-resize-cursor');
                },
                stop: function () {
                  a.removeClass('gj-unselectable'),
                ...
                drag: gj.grid.plugins.resizableColumns.private.createResizeHandle(
                  a,
                  d,
                  b.columns[e]
                ),
        ...
        return function (e, f) {
          ...
          if (
            ...
            for (i = a[0].tBodies[0].children, g = 0; g < i.length; g++)
              i[g].cells[h].setAttribute('width', k),
                (j = i[g].cells[h + 1]),
                j.setAttribute('width', l);
        };
      },
      ...
      init: function (a) {
        ...
        for (
          a.data('rowReorderColumn') &&
            (c = gj.grid.methods.getColumnPosition(
              a.data('columns'),
              a.data('rowReorderColumn')
            )),
            b = 0;
          ...
          (d = $(e[b])),
            void 0 !== c
              ? d
                  ...
                  .on(
                    'mousedown',
                    gj.grid.plugins.rowReorder.private.createRowMouseDownHandler(
                      a,
                      d
                    )
                  )
        ...
        return function (c) {
          ...
          for (
            a.addClass('gj-unselectable'),
              ...
              f
                .find(
                  'tbody tr:not([data-position="' + b.data('position') + '"])'
                )
                .remove(),
          ...
          f.draggable({
            stop: gj.grid.plugins.rowReorder.private.createDragStopHandler(
              a,
              b
            ),
          }),
            ...
            b.siblings('tr[data-role="row"]').each(function () {
              ...
              'true' === a.attr('data-droppable') && a.droppable('destroy'),
                a.droppable({
                  over: gj.grid.plugins.rowReorder.private.createDroppableOverHandler(
                    b
                  ),
              ...
              if (i.droppable('isOver', d)) {
                ...
                if (l.orderNumberField) {
                  ...
                  for (f = 0; f < c.length; f++)
                    (e = $(c[f])),
                      (h = gj.grid.methods.getId(
                        e,
                        l.primaryKey,
                        e.attr('data-position')
                      )),
                      (g = gj.grid.methods.getByPosition(
                        a,
                        e.attr('data-position')
                      )),
                      a.setCellContent(
                        h,
                        l.orderNumberField,
                        g[l.orderNumberField]
                      );
                }
              }
              i.removeClass('gj-grid-top-border'),
                i.removeClass('gj-grid-bottom-border'),
                i.droppable('destroy');
            });
        };
      },
      ...
      getCSV: function (a) {
        ...
        if (g.length) {
          for (b = 0; b < f.length; b++)
            gj.grid.plugins.export.public.isColumnApplicable(f[b]) &&
              (d +=
                '"' +
                (f[b].title || f[b].field).replace(/<[^>]+>/g, ' ') +
                '",');
          for (
            ...
            for (d = '', c = 0; c < f.length; c++)
              gj.grid.plugins.export.public.isColumnApplicable(f[c]) &&
                (d += '"' + g[b][f[c].field] + '",');
            e += d.slice(0, d.length - 1) + '\r\n';
          }
        }
        ...
        return (
          ...
          window.navigator.userAgent.indexOf('Edge') > -1
            ? (c.href = URL.createObjectURL(
                new Blob([this.getCSV(b)], { type: 'text/csv;charset=utf-8;' })
              ))
            : (c.href =
                'data:text/csv;charset=utf-8,' + escape(this.getCSV(b))),
          c.click(),
      ...
      init: function (a) {
        ...
        for (b = 0; b < d.length; b++)
          (c = $(d[b])),
            c.on(
              'mousedown',
              gj.grid.plugins.columnReorder.private.createMouseDownHandler(a, c)
            ),
            c.on(
              'mousemove',
              gj.grid.plugins.columnReorder.private.createMouseMoveHandler(a, c)
            ),
            c.on(
              'mouseup',
              gj.grid.plugins.columnReorder.private.createMouseUpHandler(a, c)
            );
      },
      createMouseDownHandler: function (a) {
        return function (b) {
      ...
      createMouseMoveHandler: function (a, b) {
        return function (c) {
          ...
          a.data('dragReady') &&
            ...
            d.find('tfoot').remove(),
            d.draggable({
              stop: gj.grid.plugins.columnReorder.private.createDragStopHandler(
                a,
                b
              ),
            }),
            ...
            b.siblings('th').each(function () {
              ...
              'true' === c.attr('data-droppable') && c.droppable('destroy'),
                c.droppable({
                  over: gj.grid.plugins.columnReorder.private.createDroppableOverHandler(
                    a,
                    b
                  ),
        ...
        return function (c, d) {
          $('table[data-role="draggable-clone"]').draggable('destroy').remove(),
            ...
            b.siblings('th').each(function () {
              var c = $(this),
                e = a.data(),
                f = gj.grid.methods.getColumnPosition(
                  e.columns,
                  c.data('field')
                ),
                g = gj.grid.methods.getColumnPosition(
                  e.columns,
                  b.data('field')
                );
              c
                ...
                c
                  .closest('table')
                  .find(
                    'tbody tr[data-role="row"] td:nth-child(' +
                      (c.index() + 1) +
                      ')'
                  )
                  .removeClass('gj-grid-left-border')
      ...
      droppableOut: function () {
        ...
        a
          ...
          a
            .closest('table')
            .find(
              'tbody tr[data-role="row"] td:nth-child(' + (a.index() + 1) + ')'
            )
            .removeClass('gj-grid-left-border')
            .removeClass('gj-grid-right-border');
      },
  ...
  (gj.grid.plugins.grouping = {
    ...
    private: {
          ...
          a.on('rowDataBound', function (d, e, f, g) {
            if (b !== g[c.grouping.groupBy] || 1 === e[0].rowIndex) {
              var h = gj.grid.methods.countVisibleColumns(a) - 1,
                i = $('<tr role="group" />'),
                j = $(
                  '<td class="gj-text-align-center gj-unselectable gj-cursor-pointer" />'
                );
              j.append(
                '<div data-role="display">' + c.icons.collapseGroup + '</div>'
              ),
                j.on(
                  'click',
                  gj.grid.plugins.grouping.private.createExpandCollapseHandler(
                    c
                  )
                ),
                i.append(j),
      ...
      grouping: function (a, b) {
        var c = a.data();
        b.sort(
          gj.grid.methods.createDefaultSorter(
            c.grouping.direction,
            c.grouping.groupBy
          )
        );
      },
      createExpandCollapseHandler: function (a) {
        return function (b) {
          ...
          'row' === c.closest('tr').next(':visible').data('role')
            ? d.collapseGroup(a, c)
            : d.expandGroup(a, c);
        };
      },
  ...
  (gj.tree.methods = {
    ...
    render: function (a, b) {
      ...
      return (
        b &&
          ...
          (c = a.data()),
          (c.records = b),
          c.primaryKey || gj.tree.methods.genAutoId(c, c.records),
    ...
    genAutoId: function (a, b) {
      ...
      for (c = 0; c < b.length; c++)
        (b[c][a.autoGenFieldName] = a.autoGenId++),
          b[c][a.childrenField] &&
            b[c][a.childrenField].length &&
            gj.tree.methods.genAutoId(a, b[c][a.childrenField]);
    },
    loadData: function (a) {
      var b,
        c = a.data('records'),
        d = a.children('ul');
      for (
        gj.tree.events.dataBinding(a), d.off().empty(), b = 0;
        b < c.length;
        b++
      )
    ...
    appendNode: function (a, b, c, d, e) {
      ...
      if (
        ((g = $('<li data-id="' + l + '" data-role="node" />').addClass(
          k.style.item
        )),
        ($wrapper = $('<div data-role="wrapper" />')),
        ($expander = $(
          '<span data-role="expander" data-mode="close"></span>'
        ).addClass(k.style.expander)),
        ($display = $(
          '<span data-role="display">' + c[k.textField] + '</span>'
        )),
        (hasChildren =
          void 0 !== c[k.hasChildrenField] &&
          'true' === c[k.hasChildrenField].toString().toLowerCase()),
        (disabled =
          void 0 !== c[k.disabledField] &&
          'true' === c[k.disabledField].toString().toLowerCase()),
        k.indentation &&
          $wrapper.append(
            '<span data-role="spacer" style="width: ' +
              k.indentation * (d - 1) +
              'px;"></span>'
          ),
        disabled
          ? gj.tree.methods.disableNode(a, g)
          : ($expander.on('click', gj.tree.methods.expanderClickHandler(a)),
            $display.on('click', gj.tree.methods.displayClickHandler(a))),
        ...
        k.imageCssClassField && c[k.imageCssClassField]
          ? ((i = $(
              '<span data-role="image"><span class="' +
                c[k.imageCssClassField] +
                '"></span></span>'
            )),
            i.insertBefore($display))
          : k.imageUrlField && c[k.imageUrlField]
          ? ((i = $('<span data-role="image"></span>')),
            i.insertBefore($display),
            (j = $('<img src="' + c[k.imageUrlField] + '"></img>')),
            j.attr('width', i.width()).attr('height', i.height()),
            i.append(j))
          : k.imageHtmlField &&
            c[k.imageHtmlField] &&
            ((i = $(
              '<span data-role="image">' + c[k.imageHtmlField] + '</span>'
            )),
            i.insertBefore($display)),
        (c[k.childrenField] && c[k.childrenField].length) || hasChildren)
      ) {
        if (
          ($expander.empty().append(k.icons.expand),
          (h = $('<ul />').addClass(k.style.list).addClass('gj-hidden')),
          g.append(h),
          c[k.childrenField] && c[k.childrenField].length)
        )
          for (f = 0; f < c[k.childrenField].length; f++)
            gj.tree.methods.appendNode(a, h, c[k.childrenField][f], d + 1);
      } else
        k.style.leafIcon
          ? $expander.addClass(k.style.leafIcon)
          : $expander.html('&nbsp;');
    ...
    expand: function (a, b, c) {
      ...
      if (
        ...
        i.length &&
        (i.show(),
        f.attr('data-mode', 'open'),
        f.empty().append(g.icons.collapse),
        c)
      )
        for (d = b.find('ul>li'), e = 0; e < d.length; e++)
    ...
    collapse: function (a, b, c) {
      ...
      if (
        ...
        i.length &&
        (i.hide(),
        f.attr('data-mode', 'close'),
        f.empty().append(g.icons.expand),
        c)
      )
        for (d = b.find('ul>li'), e = 0; e < d.length; e++)
    ...
    displayClickHandler: function (a) {
      return function (b) {
        ...
        'true' === d.attr('data-selected')
          ...
          : ('single' === a.data('selectionType') &&
              gj.tree.methods.unselectAll(a),
            gj.tree.methods.select(a, d, e));
      };
    },
    selectAll: function (a) {
      var b,
    ...
    select: function (a, b, c) {
      ...
      if (
        ...
        for (e = b.find('ul>li'), d = 0; d < e.length; d++)
        ...
        for (b = 0; b < f.length; b++)
          (c = $(f[b])),
            'true' === c.attr('data-selected')
              ...
              : c.has('ul') &&
                ((d = gj.tree.methods.getSelections(c.children('ul'))),
                d.length && (e = e.concat(d)));
      return e;
    },
    getDataById: function (a, b, c) {
      ...
      for (d = 0; d < c.length; d++) {
        ...
        if (
          c[d][e.childrenField] &&
          c[d][e.childrenField].length &&
          (f = gj.tree.methods.getDataById(a, b, c[d][e.childrenField]))
        )
          break;
      }
      return f;
    ...
    getDataByText: function (a, b, c) {
      ...
      for (d = 0; d < c.length; d++) {
        ...
        if (
          c[d][f.childrenField] &&
          c[d][f.childrenField].length &&
          (e = gj.tree.methods.getDataByText(a, b, c[d][f.childrenField]))
        )
          break;
      }
      return e;
    ...
    getNodeById: function (a, b) {
      ...
      if (f && f.length)
        for (c = 0; c < f.length; c++) {
          ...
          if (
            d.has('ul') &&
            (e = gj.tree.methods.getNodeById(d.children('ul'), b))
          )
            break;
        }
      return e;
    ...
    getNodeByText: function (a, b) {
      ...
      if (f && f.length)
        for (c = 0; c < f.length; c++) {
          if (
            ((d = $(f[c])),
            b === d.find('>[data-role="wrapper"]>[data-role="display"]').text())
          ) {
            e = d;
            break;
          }
          if (
            d.has('ul') &&
            (e = gj.tree.methods.getNodeByText(d.children('ul'), b))
          )
            break;
        }
      return e;
          ...
          ? ('li' === c[0].tagName.toLowerCase() &&
              (0 === c.children('ul').length &&
                (c
                  ...
                  .empty()
                  .append(g.icons.collapse),
                c.append($('<ul />').addClass(g.style.list))),
              (c = c.children('ul'))),
    ...
    remove: function (a, b) {
      return (
        gj.tree.methods.removeDataById(a, b.attr('data-id'), a.data('records')),
        b.remove(),
        a
      );
    },
    removeDataById: function (a, b, c) {
      ...
      for (d = 0; d < c.length; d++) {
        ...
        c[d][e.childrenField] &&
          c[d][e.childrenField].length &&
          gj.tree.methods.removeDataById(a, b, c[d][e.childrenField]);
      }
    },
    update: function (a, b, c) {
      ...
      return (
        c,
        e
          .find('>[data-role="wrapper"]>[data-role="display"]')
          .html(c[d.textField]),
  ...
  (gj.tree.plugins.checkboxes = {
    config: {
      base: { checkboxes: void 0, checkedField: 'checked', cascadeCheck: !0 },
    },
    private: {
      dataBound: function (a) {
        var b;
        a.data('cascadeCheck') &&
          ...
          $.each(b, function () {
            var a = $(this),
              b = a
                .find('[data-role="checkbox"] input[type="checkbox"]')
                .checkbox('state');
            'checked' === b &&
      ...
      nodeDataBound: function (a, b, c, d) {
        var e, f, g, h, i;
        0 ===
          b.find('> [data-role="wrapper"] > [data-role="checkbox"]').length &&
          ((e = a.data()),
          (f = b.find('> [data-role="wrapper"] > [data-role="expander"]')),
          (g = $('<input type="checkbox"/>')),
          (h = $('<span data-role="checkbox"></span>').append(g)),
          (i =
            void 0 !== d[e.disabledField] &&
            'true' === d[e.disabledField].toString().toLowerCase()),
          (g = g.checkbox({
            uiLibrary: e.uiLibrary,
            iconsLibrary: e.iconsLibrary,
            change: function (c, e) {
              gj.tree.plugins.checkboxes.events.checkboxChange(
                a,
                b,
                d,
                g.state()
        ...
        (c = a.parent('ul').parent('li')),
          1 === c.length &&
            ((d = a
              ...
              .parent('li')
              .find(
                '> [data-role="wrapper"] > [data-role="checkbox"] input[type="checkbox"]'
              )),
            (e = a
              .siblings()
              .find(
                '> [data-role="wrapper"] > span[data-role="checkbox"] input[type="checkbox"]'
              )),
            (f = 'checked' === b),
            (g = 'unchecked' === b),
            (h = 'indeterminate'),
            ...
            !f && g && (h = 'unchecked'),
            d.checkbox('state', h),
            gj.tree.plugins.checkboxes.private.updateParentState(
              c,
              d.checkbox('state')
            ));
      },
      updateChildrenState: function (a, b) {
        var c = a.find(
          'ul li [data-role="wrapper"] [data-role="checkbox"] input[type="checkbox"]'
        );
        c.length > 0 &&
          $.each(c, function () {
    ...
    public: {
      getCheckedNodes: function () {
        ...
        return (
          $.each(b, function () {
            var b = $(this);
            'checked' === b.checkbox('state') &&
              a.push(b.closest('li').data('id'));
          }),
          a
        );
      },
      ...
      check: function (a) {
        return (
          gj.tree.plugins.checkboxes.private.update(this, a, 'checked'), this
        );
      },
      uncheck: function (a) {
        return (
          gj.tree.plugins.checkboxes.private.update(this, a, 'unchecked'), this
        );
      },
    },
    events: {
    ...
    private: {
      nodeDataBound: function (a, b) {
        ...
        c.length &&
          ...
          (d.on(
            'mousedown',
            gj.tree.plugins.dragAndDrop.private.createNodeMouseDownHandler(a)
          ),
          d.on(
            'mousemove',
            gj.tree.plugins.dragAndDrop.private.createNodeMouseMoveHandler(
              a,
              b,
              d
            )
          ...
          d.on(
            'mouseup',
            gj.tree.plugins.dragAndDrop.private.createNodeMouseUpHandler(a)
          ));
      },
        ...
        return function (d) {
          if (a.data('dragReady')) {
            ...
            a.data('dragReady', !1),
              ...
              e
                .find('[data-role="wrapper"]')
                .prepend('<span data-role="indicator" />'),
              e.draggable({
                drag: gj.tree.plugins.dragAndDrop.private.createDragHandler(
                  a,
                  b,
                  c
                ),
                stop: gj.tree.plugins.dragAndDrop.private.createDragStopHandler(
                  a,
                  b,
                  c
                ),
              ...
              (g = c.offset().top),
              (g -=
                parseInt(f.css('border-top-width')) +
                parseInt(f.css('margin-top')) +
                parseInt(f.css('padding-top'))),
              (h = c.offset().left),
              (h -=
              ...
              'true' === c.attr('data-droppable') && c.droppable('destroy'),
              gj.tree.plugins.dragAndDrop.private
                .getTargetDisplays(a, b, c)
                .each(function () {
                  var a = $(this);
                  'true' === a.attr('data-droppable') && a.droppable('destroy'),
                    a.droppable();
          ...
          d.each(function () {
            ...
            if (b.droppable('isOver', c))
              return (
                ...
                f.style.dropAsChildIcon
                  ? a.addClass(f.style.dropAsChildIcon)
                  : a.text('+'),
                (h = !0),
                !1
              );
            g.find('[data-role="indicator"]')
            ...
            e.each(function () {
              ...
              !h && b.droppable('isOver', c)
                ? ((a = b.position().top + b.outerHeight() / 2),
                  c.y < a
                    ? b
                        .addClass(f.style.dropAbove)
                        .removeClass(f.style.dropBelow)
                    : b
                        .addClass(f.style.dropBelow)
                        .removeClass(f.style.dropAbove))
                : b
                    .removeClass(f.style.dropAbove)
                    .removeClass(f.style.dropBelow);
            });
            ...
            d.each(function () {
              ...
              if (d.droppable('isOver', g))
                return (
                  ...
                  (c = i.children('ul')),
                  0 === c.length &&
                    ((c = $('<ul />').addClass(f.style.list)), i.append(c)),
                  !1 !==
                    gj.tree.plugins.dragAndDrop.events.nodeDrop(
                      a,
                      b.data('id'),
                      i.data('id'),
                      c.children('li').length + 1
                    ) &&
                    (c.append(b),
              ...
              e.each(function () {
                ...
                if (k.droppable('isOver', g))
                  return (
                    ...
                    (e = b.data('id')),
                    (d =
                      i.prevAll('li:not([data-id="' + e + '"])').length +
                      (c ? 1 : 2)),
                    !1 !==
                      gj.tree.plugins.dragAndDrop.events.nodeDrop(
                        a,
                        e,
                        i.parent('ul').parent('li').data('id'),
                        d
                      ) &&
                      ((h = a.getDataById(b.data('id'))),
                      gj.tree.methods.removeDataById(
                        a,
                        b.data('id'),
                        f.records
                      ),
                      a
                        .getDataById(i.parent().data('id'))
                        [f.childrenField].splice(i.index() + (c ? 0 : 1), 0, h),
      ...
      refreshNode: function (a, b) {
        ...
        f.length && f.children().length
          ? f.is(':visible')
            ? d.empty().append(g.icons.collapse)
            : d.empty().append(g.icons.expand)
          : d.empty(),
      ...
      createDoneHandler: function (a, b) {
        return function (c) {
          var d,
            ...
            g = a.data();
          if (
            ('string' == typeof c && JSON && (c = JSON.parse(c)), c && c.length)
          ) {
            for (
              f = b.children('ul'),
                0 === f.length &&
                  ((f = $('<ul />').addClass(g.style.list)), b.append(f)),
                d = 0;
              d < c.length;
              d++
            )
  ...
  (gj.checkbox.config = {
    ...
    bootstrap: {
      style: { wrapperCssClass: 'gj-checkbox-bootstrap' },
      iconsLibrary: 'glyphicons',
    },
    bootstrap4: {
      style: {
    ...
    glyphicons: {
      style: { iconsCssClass: 'gj-checkbox-glyphicons', spanCssClass: '' },
    },
    fontawesome: {
      style: { iconsCssClass: 'gj-checkbox-fontawesome', spanCssClass: 'fa' },
    },
  }),
  (gj.checkbox.methods = {
    init: function (a) {
    ...
    state: function (a, b) {
      return b
        ? ('checked' === b
            ...
            : 'indeterminate' === b &&
              (a.prop('checked', !0), a.prop('indeterminate', !0)),
          gj.checkbox.events.change(a, b),
          a)
        : (b = a.prop('indeterminate')
            ? 'indeterminate'
            : a.prop('checked')
            ? 'checked'
            : 'unchecked');
    ...
    toggle: function (a) {
      return (
        'checked' == a.state() ? a.state('unchecked') : a.state('checked'), a
      );
    },
    destroy: function (a) {
      return (
    ...
    initialize: function (a) {
      ...
      if (
        ...
        0 === e.length &&
          ((e = $('<div role="body"></div>')),
          $(d).append(e),
          a[0].innerText && (e[0].innerHTML = a[0].innerText)),
        e.attr('contenteditable', !0),
        e.on('keydown', function (b) {
          var c = event.keyCode || event.charCode;
          !1 === gj.editor.events.changing(a) &&
            8 !== c &&
            46 !== c &&
            b.preventDefault();
        }),
    ...
    updateToolbar: function (a, b) {
      ...
      $buttons = b.find('[role]').each(function () {
        var a = $(this),
          b = a.attr('role');
        b &&
        document.queryCommandEnabled(b) &&
        'true' === document.queryCommandValue(b)
  ...
  (gj.dropdown.config = {
    ...
    bootstrap: {
      style: {
        wrapper:
          'gj-dropdown gj-dropdown-bootstrap gj-dropdown-bootstrap-3 gj-unselectable',
    ...
    bootstrap4: {
      style: {
        wrapper:
          'gj-dropdown gj-dropdown-bootstrap gj-dropdown-bootstrap-4 gj-unselectable',
  ...
  (gj.dropdown.methods = {
    ...
    initialize: function (a) {
      var b = a.data(),
        ...
        e = $('<span role="expander">' + b.icons.dropdown + '</span>').addClass(
          b.style.expander
        ),
        f = $('<button role="presenter" type="button"></button>').addClass(
          b.style.presenter
        ),
        g = $('<ul role="list" class="' + b.style.list + '"></ul>').attr(
          'guid',
          a.attr('data-guid')
        );
      0 === c.length
        ? ((c = $('<div role="wrapper" />').addClass(b.style.wrapper)),
          a.wrap(c))
        : c.addClass(b.style.wrapper),
    ...
    setListPosition: function (a, b, c) {
      ...
      (b.style.overflow = ''),
        ...
        'auto' === c.maxHeight
          ? h.top < g.top
            ? h.top + d + e > window.innerHeight &&
              (f = window.innerHeight - h.top - e - 3)
            : h.top - d - 3 > 0
    ...
    render: function (a, b) {
      var c = [],
        ...
        e = a.parent(),
        f = $('body').children(
          '[role="list"][guid="' + a.attr('data-guid') + '"]'
        ),
        ...
        if (
          ($.each(b, function () {
            var b,
              ...
              g = this[d.textField],
              h =
                this[d.selectedField] &&
                'true' === this[d.selectedField].toString().toLowerCase();
            (b = $(
              '<li value="' +
                e +
                '"><div data-role="wrapper"><span data-role="display">' +
                g +
                '</span></div></li>'
            )),
          ...
          a.prepend('<option value=""></option>'),
            ...
            d.placeholder &&
              (h[0].innerHTML =
                '<span class="placeholder">' + d.placeholder + '</span>');
    ...
    open: function (a, b) {
      ...
      b.css('width', gj.core.width(e[0])),
        ...
        f &&
          ...
          gj.dropdown.methods.addParentsScrollListener(
            f,
            c.parentScrollHandler
          ));
    },
    close: function (a, b) {
      var c = a.data(),
      ...
      d.html(c.icons.dropdown),
        e &&
          c.parentScrollHandler &&
          gj.dropdown.methods.removeParentsScrollListener(
            e,
            c.parentScrollHandler
          ),
        b.hide();
      ...
      return (
        ...
        g
          ? (e.addClass(c.style.active),
            (a[0].value = b),
            (f[0].innerHTML = g[c.textField]))
          : (c.placeholder &&
              (f[0].innerHTML =
                '<span class="placeholder">' + c.placeholder + '</span>'),
            (a[0].value = '')),
    ...
    destroy: function (a) {
      ...
      return (
        b &&
          ...
          a.removeClass(),
          c.length > 0 &&
            (c.children('[role="presenter"]').remove(),
            c.children('[role="list"]').remove(),
            a.unwrap()),
          a.show()),
        a
      );
  ...
  (gj.dropdown.widget.prototype.getHTMLConfig =
    gj.dropdown.methods.getHTMLConfig),
  (function (a) {
  ...
  (gj.datepicker.methods = {
    ...
    initialize: function (a, b) {
      ...
      0 === e.length
        ? ((e = $('<div role="wrapper" />').addClass(b.style.wrapper)),
          a.wrap(e))
        ...
        'bootstrap' === b.uiLibrary || 'bootstrap4' === b.uiLibrary
          ? 'small' === b.size
            ...
            : 'large' === b.size &&
              (e.addClass('input-group-lg'), a.addClass('form-control-lg'))
          : 'small' === b.size
          ? e.addClass('small')
        ...
        !0 !== b.footer &&
          ...
          c.mousedown(function () {
            return (
              ...
              document.activeElement !== a[0] && a.focus(),
              !1
            );
          }),
          c.on('click', function () {
        ...
        b.keyboardNavigation &&
          $(document).on(
            'keydown',
            gj.datepicker.methods.createKeyDownHandler(a, c, b)
          );
    },
    createCalendar: function (a, b) {
      ...
      return (
        ...
        b.footer &&
          ...
          (f = $(
            '<button class="' +
              b.style.button +
              '">' +
              gj.core.messages[b.locale].cancel +
              '</button>'
          )),
          f.on('click', function () {
            a.close();
        ...
        $('body').append(h),
        b.modal &&
          (h.wrapAll('<div role="modal" class="' + b.style.modal + '"/>'),
          gj.core.center(h)),
        h
      );
    },
    ...
    createNavigation: function (a, b, c, d) {
      ...
      for (
        f = $('<div role="navigator" />'),
          f.append(
            $('<div>' + d.icons.previousMonth + '</div>').on(
              'click',
              gj.datepicker.methods.prev(a, d)
            )
          ),
          f.append(
            $('<div role="period"></div>').on(
              'click',
              gj.datepicker.methods.changePeriod(a, d)
            )
          ),
          f.append(
            $('<div>' + d.icons.nextMonth + '</div>').on(
              'click',
              gj.datepicker.methods.next(a, d)
            )
          ),
          b.append(f),
          e = $('<tr role="week-days" />'),
    ...
    renderMonth: function (a, b, c) {
      ...
      for (
        s.off().empty(),
          ...
          b.attr('type', 'month'),
          v = v
            .replace('mmmm', gj.core.messages[c.locale].monthNames[g])
            .replace('yyyy', h),
          ...
          c.showOtherMonths &&
            ...
            c.selectOtherMonths && gj.datepicker.methods.isSelectable(c, r)
              ? (p
                ...
                q.on(
                  'click',
                  gj.datepicker.methods.dayClickHandler(a, b, c, r)
                ),
      ...
      t.append(u),
        ...
        b.attr('selectedDay') &&
          ...
          b
            .find('tbody td[day="' + e[2] + '"][month="' + e[1] + '"]')
            .addClass('selected'),
    ...
    renderYear: function (a, b, c) {
      ...
      for (
        ...
        for ($row = $('<tr />'), f = 4 * e; f <= 4 * e + 3; f++)
          (g = $(
            '<div>' + gj.core.messages[c.locale].monthShortNames[f] + '</div>'
          )),
      ...
      return (
        a.minDate &&
          ('string' == typeof a.minDate
            ...
            ? 'string' == typeof (b = a.minDate()) &&
              (b = gj.core.parseDate(b, a.format, a.locale))
        ...
        if (a.disableDates)
          if ($.isArray(a.disableDates))
            for (c = 0; c < a.disableDates.length; c++)
              a.disableDates[c] instanceof Date &&
              a.disableDates[c].getTime() === b.getTime()
                ? (d = !1)
                : 'string' == typeof a.disableDates[c] &&
                  gj.core
                    .parseDate(a.disableDates[c], a.format, a.locale)
                    .getTime() === b.getTime() &&
                  (d = !1);
          else a.disableDates instanceof Function && (d = a.disableDates(b));
        $.isArray(a.disableDaysOfWeek) &&
          a.disableDaysOfWeek.indexOf(b.getDay()) > -1 &&
          (d = !1);
      }
      return d;
    },
    ...
    prev: function (a, b) {
      return function () {
        var c,
          ...
          g,
          h = $('body').find(
            '[role="calendar"][guid="' + a.attr('data-guid') + '"]'
          );
    ...
    dayClickHandler: function (a, b, c, d) {
      return function (e) {
        return (
          ...
          !0 !== c.footer &&
            !1 !== c.autoClose &&
            gj.datepicker.methods.change(a, b, c, d),
          a
        );
      };
    },
    ...
    open: function (a, b) {
      ...
      switch (
        (a.val()
          ? a.value(a.val())
          : ((c = new Date()),
            d.attr('month', c.getMonth()),
            d.attr('year', c.getFullYear())),
        d.attr('type'))
      ) {
        case 'month':
      ...
      d.show(),
        ...
        b.modal
          ? gj.core.center(d)
          : (gj.core.setChildPosition(a[0], d[0]),
            document.activeElement !== a[0] && a.focus()),
        clearTimeout(a.timeout),
              ...
              i.is('[day]') ||
                ...
                i.is(':empty') &&
                  (i = b
                    ...
                    .find('td:eq(' + h + ')'))),
              i.is('[day]') &&
                (i.addClass('focused'), j.removeClass('focused')))
            : '40' == d.keyCode
            ? ((h = j.index()),
              (i = j
                .closest('tr')
              ...
              i.is('[day]') ||
                ...
                (i = b
                  ...
                  .find('td:eq(' + h + ')')),
                i.is('[day]') ||
                  (i = b.find('tbody tr:eq(1)').find('td:eq(' + h + ')'))),
              i.is('[day]') &&
                (i.addClass('focused'), j.removeClass('focused')))
            : '37' == d.keyCode
            ? ((i = j.prev('td[day]:not(.disabled)')),
              0 === i.length &&
                (i = j.closest('tr').prev('tr').find('td[day]').last()),
              0 === i.length &&
                (gj.datepicker.methods.prev(a, c)(),
                (i = b.find('tbody tr').last().find('td[day]').last())),
              i.length > 0 && (i.addClass('focused'), j.removeClass('focused')))
            : '39' == d.keyCode
            ? ((i = j.next('[day]:not(.disabled)')),
              0 === i.length &&
                (i = j.closest('tr').next('tr').find('td[day]').first()),
              0 === i.length &&
                (gj.datepicker.methods.next(a, c)(),
                (i = b.find('tbody tr').first().find('td[day]').first())),
              i.length > 0 && (i.addClass('focused'), j.removeClass('focused')))
            : '13' == d.keyCode
            ? ((g = parseInt(j.attr('day'), 10)),
              (e = parseInt(j.attr('month'), 10)),
              (f = parseInt(j.attr('year'), 10)),
              gj.datepicker.methods.dayClickHandler(
                a,
                b,
                c,
                new Date(f, e, g)
    ...
    getActiveCell: function (a) {
      ...
      return (
        0 === b.length &&
          ...
          0 === b.length &&
            ((b = a.find('td[day].today')),
            0 === b.length && (b = a.find('td[day]:not(.disabled)').first()))),
        b
      );
    },
    value: function (a, b) {
  ...
  (gj.timepicker.methods = {
      ...
      var b,
        ...
        k = $(
          '<button class="' +
            c.style.button +
            '">' +
            gj.core.messages[c.locale].cancel +
            '</button>'
        ),
      ...
      return (
        ...
        c.header &&
          ...
          'ampm' === c.mode &&
            (h.append(
              $(
                '<span role="am">' + gj.core.messages[c.locale].am + '</span>'
              ).on('click', function () {
            ...
            h.append(
              $(
                '<span role="pm">' + gj.core.messages[c.locale].pm + '</span>'
              ).on('click', function () {
                var b = gj.timepicker.methods.getHour(d);
                d.attr('mode', 'pm'),
                  $(this).addClass('selected'),
        ...
        $('body').append(d),
        c.modal &&
          (d.wrapAll('<div role="modal" class="' + c.style.modal + '"/>'),
          gj.core.center(d)),
        d
      );
    },
    ...
    updateArrow: function (a, b, c, d) {
      ...
      (e = a.target.getBoundingClientRect()),
        'hours' == d.dialMode
          ? ((f = gj.timepicker.methods.getPointerValue(
              g - j - e.left,
              h - i - e.top,
              d.mode
            )),
            c.attr(
              'hour',
              'ampm' === d.mode && 'pm' === c.attr('mode') && f < 12
                ? f + 12
                : f
            ))
          : 'minutes' == d.dialMode &&
    ...
    update: function (a, b, c) {
      ...
      (d = gj.timepicker.methods.getHour(b)),
        ...
        i
          .filter(function (a) {
            return 'hours' == c.dialMode
              ? parseInt($(this).text(), 10) == g
              : parseInt($(this).text(), 10) == e;
          })
          .addClass('selected'),
        c.header &&
          ...
          'ampm' === c.mode &&
            (d >= 12
              ? (h.find('[role="pm"]').addClass('selected'),
                h.find('[role="am"]').removeClass('selected'))
              : (h.find('[role="am"]').addClass('selected'),
                h.find('[role="pm"]').removeClass('selected'))));
    },
    ...
    mouseUpHandler: function (a, b, c) {
      return function (d) {
        gj.timepicker.methods.updateArrow(d, a, b, c),
          ...
          'hours' == c.dialMode
            ? setTimeout(function () {
                gj.timepicker.events.select(a, 'hour'),
                  gj.timepicker.methods.renderMinutes(a, b, c);
              }, 1e3)
            : 'minutes' == c.dialMode &&
              (!0 !== c.footer &&
                !1 !== c.autoClose &&
                gj.timepicker.methods.setTime(a, b)(),
    ...
    renderHours: function (a, b, c) {
      ...
      clearTimeout(a.timeout),
        ...
        d.append(
          '<span role="hour" style="transform: translate(54px, -93.5307px);">1</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(93.5307px, -54px);">2</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(108px, 0px);">3</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(93.5307px, 54px);">4</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(54px, 93.5307px);">5</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(6.61309e-15px, 108px);">6</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(-54px, 93.5307px);">7</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(-93.5307px, 54px);">8</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(-108px, 1.32262e-14px);">9</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(-93.5307px, -54px);">10</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(-54px, -93.5307px);">11</span>'
        ),
        d.append(
          '<span role="hour" style="transform: translate(-1.98393e-14px, -108px);">12</span>'
        ),
        '24hr' === c.mode &&
          (d.append(
            '<span role="hour" style="transform: translate(38px, -65.8179px);">13</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(65.8179px, -38px);">14</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(76px, 0px);">15</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(65.8179px, 38px);">16</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(38px, 65.8179px);">17</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(4.65366e-15px, 76px);">18</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(-38px, 65.8179px);">19</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(-65.8179px, 38px);">20</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(-76px, 9.30732e-15px);">21</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(-65.8179px, -38px);">22</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(-38px, -65.8179px);">23</span>'
          ),
          d.append(
            '<span role="hour" style="transform: translate(-1.3961e-14px, -76px);">00</span>'
          )),
        e.append(d),
    ...
    renderMinutes: function (a, b, c) {
      ...
      clearTimeout(a.timeout),
        ...
        $dial.append(
          '<span role="hour" style="transform: translate(108px, 0px);">15</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(93.5307px, 54px);">20</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(54px, 93.5307px);">25</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(6.61309e-15px, 108px);">30</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(-54px, 93.5307px);">35</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(-93.5307px, 54px);">40</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(-108px, 1.32262e-14px);">45</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(-93.5307px, -54px);">50</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(-54px, -93.5307px);">55</span>'
        ),
        $dial.append(
          '<span role="hour" style="transform: translate(-1.98393e-14px, -108px);">00</span>'
        ),
        d.append($dial),
    ...
    open: function (a) {
      var b,
        ...
        d = a.data(),
        e = $('body').find(
          '[role="picker"][guid="' + a.attr('data-guid') + '"]'
        );
      return (
        (b = a.value()
          ? gj.core.parseDate(a.value(), d.format, d.locale)
          : new Date()),
        (c = b.getHours()),
    ...
    value: function (a, b) {
      ...
      return void 0 === b
        ? a.val()
        : (a.val(b), gj.timepicker.events.change(a), a);
    },
  }),
  ...
  (gj.datetimepicker.methods = {
    ...
    getConfig: function (a, b) {
      ...
      return (
        ...
        gj.datepicker.config[uiLibrary] &&
          $.extend(!0, c.datepicker, gj.datepicker.config[uiLibrary]),
        gj.timepicker.config[uiLibrary] &&
          $.extend(!0, c.timepicker, gj.timepicker.config[uiLibrary]),
        (iconsLibrary = a.hasOwnProperty('iconsLibrary')
          ? a.iconsLibrary
          : c.iconsLibrary),
        gj.datepicker.config[iconsLibrary] &&
          $.extend(!0, c.datepicker, gj.datepicker.config[iconsLibrary]),
        gj.timepicker.config[iconsLibrary] &&
          $.extend(!0, c.timepicker, gj.timepicker.config[iconsLibrary]),
        c
      );
    },
    initialize: function (a) {
      ...
      (j.datepicker.uiLibrary = j.uiLibrary),
        ...
        a.on('open', function () {
          ...
          a.find('[role="calendarMode"]').addClass('selected'),
            a.find('[role="clockMode"]').removeClass('selected');
        }),
        (b = $('body').find(
          '[role="calendar"][guid="' + a.attr('data-guid') + '"]'
        )),
        (f = j.value
          ? gj.core.parseDate(j.value, j.format, j.locale)
          : new Date()),
        ...
        e.append(
          $('<div role="minute" />')
            .on(
              'click',
              gj.datetimepicker.methods.createShowMinuteHandler(a, b, j)
            )
    ...
    createShowHourHandler: function (a, b, c) {
      return function () {
        ...
        d.find('[role="calendarMode"]').removeClass('selected'),
          ...
          gj.timepicker.methods.initMouse(
            b.children('[role="body"]'),
            a,
            b,
            c.timepicker
          ),
  ...
  (gj.datetimepicker.widget.prototype.getConfig =
    gj.datetimepicker.methods.getConfig),
  (function (a) {
  ...
  (gj.slider.methods = {
    ...
    initialize: function (a, b) {
      ...
      (a[0].style.display = 'none'),
        ...
        e.addEventListener(
          'mousedown',
          gj.slider.methods.createMouseDownHandler(e, b)
        ),
        gj.documentManager.subscribeForEvent(
          'mousemove',
          a.data('guid'),
        ...
        c.addEventListener(
          'click',
          gj.slider.methods.createClickHandler(a, d, e, b)
        );
    },
    ...
    createMouseUpHandler: function (a, b, c) {
      return function (c) {
        'true' === b.getAttribute('drag') &&
          (b.setAttribute('drag', 'false'), gj.slider.events.change(a));
      };
    },
      ...
      return function (d) {
        ...
        'true' === c.getAttribute('drag') &&
          ...
          g >= i &&
            g <= h + i &&
            (g > k + j / 2 || g < k - j / 2) &&
            ((l = Math.round((g - i) / j) + e.min),
            gj.slider.methods.value(a, e, l)));
      };
    },
  ...
  (gj.colorpicker.methods = {
    init: function (a) {
      return (
        gj.picker.widget.prototype.init.call(this, a, 'colorpicker'),
